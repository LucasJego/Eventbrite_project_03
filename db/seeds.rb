...
10.times do
	user = User.new(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: "#{Faker::Name.first_name}@yopmail.com", description: Faker::Lorem.sentence(word_count: 20), encrypted_password: 'abcdefgh')
	user.save
	users_array << user
